  ...
  return (
    <motion.header
      ...
      className={`fixed top-0 left-0 right-0 z-50 transition-all duration-200 ${
        isScrolled ? "bg-white/95 backdrop-blur-md shadow-lg border-b border-neutral-light/20" : "bg-transparent"
      }`}
    >
        ...
        <div className="flex items-center justify-between h-14 lg:h-16">
          ...
          <div className="lg:hidden">
            <motion.button
              ...
              className="p-2 rounded-lg text-neutral-dark hover:bg-beige-200 transition-colors duration-150"
            >
              {isOpen ? (
                <X className="w-6 h-6" />
              ) : (
